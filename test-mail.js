...
const testMail = async () => {
    ...
    const welcomeEmailBody = `
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            <h2 style="color: #1a3c5a;">TEST: Welcome to Girik Class, ${name}!</h2>
            ...
            <br>
            <p>Best Regards,<br><strong>Girik Class Dev Team</strong></p>
        </div>
    `;

    console.log(`Sending test mail to ${to}...`);
    const success = await emailService.sendEmail(to, 'Girik Class - Manual Test Email', welcomeEmailBody, 'system');

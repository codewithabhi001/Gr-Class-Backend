...
const seedStaticContent = async () => {
    try {
        ...
        await db.SiteStaticContent.create({
            ...
            body_html: `
                <section>
                    <h1>GR-Class: Redefining Maritime Safety</h1>
                    <p>
                        Established as a leading <strong>Recognized Organization (RO)</strong>, 
                        GR-Class provides comprehensive classification and statutory services to the global maritime industry. 
                    ...
                    <p>
                        At GR-Class, we don't just inspect; we partner with shipowners and management companies to ensure 
        ...
        await db.SiteStaticContent.create({
            ...
            faq_items: [
                ...
                },
                {
                    ...
                    answer: 'Surveys can be scheduled via the GR-Class Ops portal. Once a request is submitted, our operations team assigns a surveyor based on location and expertise. Clients can track the status from "Assigned" to "Certified" in real-time.',
                    sort_order: 1
                },
                {
                    question: 'Are digital certificates issued by GR-Class legally valid?',
                    answer: 'Yes. All certificates issued by GR-Class are digitally signed and include a secure QR code for instant verification by Port State Control (PSC) and other authorities, ensuring full compliance with IMO guidelines.',
                    sort_order: 2
                },
                {
                ...
                {
                    question: 'Which flag administrations recognize GR-Class?',
                    answer: 'GR-Class is authorized by several prominent flag states to act as their Recognized Organization. Contact our compliance department at compliance@grclass.com for the full list of authorizations.',
                    sort_order: 4
                }
            ],
            is_published: true
        ...
        await db.SiteStaticContent.create({
            ...
            body_html: `
                <section>
                    ...
                    <p>
                        In the maritime industry, data integrity is paramount. GR-Class maintains a secure environment for all 
                        vessel documentation, technical drawings, and surveyor reports.
                    </p>

                    <h3>Confidentiality and Data Residency</h3>
                    <p>
                        We respect the commercial sensitivity of fleet data. All information submitted to GR-Class is 
        ...
        await db.SiteStaticContent.create({
            slug: 'gr-class-expands-network-middle-east',
            title: 'Expansion: GR-Class Opens New Survey Hub in Dubai',
            content_type: 'NEWS',
            body_html: `
                <article>
                    <h2>Boosting Services in the GCC Region</h2>
                    <p>To better serve our growing fleet in the Middle East, GR-Class is excited to announce the opening of its latest technical hub in Dubai, UAE.</p>
        ...
        await db.SiteStaticContent.create({
            ...
            body_html: `
                <article>
                    ...
                    <p>GR-Class has successfully integrated blockchain technology into its digital certification pipeline.</p>
        ...
        await db.SiteStaticContent.create({
            ...
            body_html: `
                <article>
                    ...
                    <p>Our annual report on global vessel compliance reveals a 15% improvement in emission reduction among the GR-classed fleet.</p>

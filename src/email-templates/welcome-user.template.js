...
export const render = (data) => {
    ...
    const innerHtml = `
      ...
      <div style="background: #f4f4f5; padding: 20px; border-radius: 8px; margin: 20px 0; border: 1px solid #e4e4e7;">
        <p style="margin:0 0 8px;"><strong>Login Page:</strong> <a href="${loginUrl}" style="color: #2563eb; text-decoration: none;">${loginUrl}</a></p>
        <p style="margin:0 0 8px;"><strong>Email:</strong> ${userEmail}</p>
        <p style="margin:0;"><strong>Temporary Password:</strong> <code style="background: #e4e4e7; padding: 2px 4px; border-radius: 4px;">${userPassword}</code></p>
      </div>
      ...
      <p style="margin:0 0 20px;">
        <a href="${loginUrl}" style="display:inline-block;background:#18181b;color:#fafafa;text-decoration:none;padding:12px 24px;border-radius:6px;font-weight:600;font-size:14px;">Log in to Portal</a>
      </p>

      <p style="margin:0;color:#52525b;font-size:14px;">If you face any issues while logging in, please contact the IT support team.</p>
    `;

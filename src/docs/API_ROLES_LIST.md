...
- `GET /api/website/static-content/news`
- `GET /api/website/static-content/privacy`
- `GET /api/website/static-content/terms-and-conditions`
- `GET /api/website/static-content/terms-compliance`
...
- `GET /api/certificate-templates/get-upload-url`
...
- `POST /api/activity-requests/:id/convert-to-job`
- `POST /api/approvals`
- `POST /api/auth/change-password`
- `POST /api/auth/forgot-password`
- `POST /api/auth/login`
...
- `POST /api/users`
- `POST /api/vessels`
- `POST /api/website/newsletter/send`
- `POST /api/website/newsletter/subscribe`
- `POST /api/website/newsletter/unsubscribe`
- `POST /api/website/newsletter/unsubscribe-one-click`
- `POST /api/website/static-content/admin`
...
- `PUT /api/users/profile-pic`
- `PUT /api/vessels/:id`
- `PUT /api/website/static-content/admin/:key`
...
- `GET /api/checklists/jobs/:jobId/signed-checklist-upload-url`
- `GET /api/dashboard`
- `GET /api/documents/:entityType/:entityId`
- `GET /api/documents/:id`
- `GET /api/documents/get-upload-url`
...
- `PUT /api/checklists/jobs/:jobId/signed-checklist-files`
- `PUT /api/notifications/:id/read`
- `PUT /api/notifications/read-all`
- `PUT /api/users/fcm-token`
- `PUT /api/users/me`
